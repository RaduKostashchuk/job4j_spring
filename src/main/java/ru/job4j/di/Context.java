    ...
    public void reg(Class cl) {
        ...
        for (Class arg : con.getParameterTypes()) {
            if (!els.containsKey(arg.getCanonicalName())) {
                throw new IllegalStateException("Context doesn't have such object: " + arg.getCanonicalName());
            }
        ...
        try {
            ...
            throw new IllegalStateException("Can't create instance of " + cl.getCanonicalName(), e);
        }
    }
